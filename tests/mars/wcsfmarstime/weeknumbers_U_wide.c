...
int main()
{
    ...
    wcsfmarstime(str, sizeof(str), L"%U", &week0);
    printf("%ls ", str);
    ...
    wcsfmarstime(str, sizeof(str), L"%U", &firstMonday);
    printf("%ls ", str);
    ...
    wcsfmarstime(str, sizeof(str), L"%U", &week1);
    printf("%ls ", str);
    ...
    wcsfmarstime(str, sizeof(str), L"%U", &secondMonday);
    printf("%ls ", str);
    ...
    wcsfmarstime(str, sizeof(str), L"%U", &lastDayOfSeason);
    printf("%ls ", str);
    ...
    wcsfmarstime(str, sizeof(str), L"%U", &firstPisces);
    printf("%ls ", str);
    ...
    wcsfmarstime(str, sizeof(str), L"%U", &firstGemini);
    printf("%ls ", str);
    ...
    wcsfmarstime(str, sizeof(str), L"%U", &leapDay);
    printf("%ls", str);
}
